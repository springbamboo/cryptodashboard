          ...
          <TableBody>
            {rowsBtc.map((row, i) => (
              <TableRow key={i}>
                ...
                <TableCell
                  align="left"
                  className={styles[cellStylesBtc.current[i].price]}
                >
                  {row.Price}
                </TableCell>
                <TableCell
                  align="left"
                  className={styles[cellStylesBtc.current[i].long]}
                >
                  {row.Long}
                </TableCell>
                <TableCell
                  align="left"
                  className={styles[cellStylesBtc.current[i].short]}
                >
                  {row.Short}
                </TableCell>
                <TableCell
                  align="left"
                  className={styles[cellStylesBtc.current[i].funding]}
                >
                  {row.Funding}
                </TableCell>
                <TableCell
                  align="left"
                  className={styles[cellStylesBtc.current[i].hVolume]}
                >
                  {row.HVolume}
                </TableCell>
                <TableCell
                  align="left"
                  className={styles[cellStylesBtc.current[i].hChanged]}
                >
                  {row.HChanged}
                </TableCell>
              </TableRow>
